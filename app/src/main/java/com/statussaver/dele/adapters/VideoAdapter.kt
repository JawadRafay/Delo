...
class VideoAdapter(val data : List<StatusModel>, val context: Context) : RecyclerView.Adapter<VideoAdapter.MyViewHolder>() {

    var onCheckboxListener: OnCheckboxListener? = null
